...
<body class="bg-light">
    ...
    <div class="container py-5">
        ...
        <a href="../admin/adminPanel.php" class="btn btn-outline-info">
            <i class="bi bi-arrow-left-square"></i> 返回後台管理
        </a>
        <a href="../user/login.php" class="btn btn-outline-dark">
            <i class="bi bi-box-arrow-in-left"></i> 返回登入畫面
        </a>
    </div>
